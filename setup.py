...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        (os.path.join('share', 'applications'),               ['electrum-avian.desktop']),
...
setup(
    ...
    scripts=['electrum/electrum_avian'],
    data_files=data_files,
    description="Lightweight Avian Wallet",
    author="Thomas Voegtlin",
    author_email="thomasv@electrum.org",
    license="MIT Licence",
    url="https://electrum.org",
    long_description="""Lightweight Avian Wallet""",
)
