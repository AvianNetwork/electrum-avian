...
class UpdateCheck(QDialog, Logger):
    url = "https://raw.githubusercontent.com/AvianNetwork/electrum-avian/master/check-version.json"
    download_url = "https://github.com/AvianNetwork/electrum-avian/releases"

    VERSION_ANNOUNCEMENT_SIGNING_KEYS = (
        "RJr6mdaEV381zz5kjF3uxYACh1DmYpsc8J",  # CraigD
    )
